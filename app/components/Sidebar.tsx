...
export default function Sidebar({
  ...
  return (
    <aside className={`w-56 h-full flex flex-col border-r select-none shrink-0 transition-colors duration-300 ${isWeather ? "border-white/[0.06] bg-neutral-800/50" : "border-white/[0.06] bg-neutral-800/50"}`}>
      {/* Drag area + branding */}
      <div
